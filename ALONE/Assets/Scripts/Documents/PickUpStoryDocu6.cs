...
public class PickUpStoryDocu6 : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        document = GameObject.Find("UI/StatsCanvas/AllDocuments/MilitiaLog6");
        //docu = GameObject.FindGameObjectWithTag("StoryDocument6");
